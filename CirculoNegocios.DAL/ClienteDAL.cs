        ...
        public List<ClienteEntity> ConsultaClientesByTextoBusca(string estado, string texto)
        {
            ...
            try
            {
                using (var context = new CirculoNegocioEntities())
                {
                    ...
                    //var ret = context.tbClientes.Join(context.tbClientes, b => b.idCliente, c => c.id, (b, c) => new { b.id, b.idCliente, c.nome, b.Ativo, b.dataAte, b.dataDe, b.DataUltimaAlteracao, b.estado, b.idTipoBanner, b.imagemFilePath, b.responsavelUltimaAlteracao }).ToList();
                    ...
                    var ret = (from c in context.tbClientes
                               ...
                               where c.nome.Contains(texto) || ca.Nome.Contains(texto) || sca.Nome.Contains(texto)
